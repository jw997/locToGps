...
generate ccrs json in ccrsViewer build processAll.sh by downloading data from ccrs in csv form and converting to ccrs json form

read ccrsjson from input/ccrtest
write updated json to output/ccrtest
*/
...
const ccrsJsonDirectory = process.argv[3] ?? './input/ccrstest/';
const outputCcrsDirectory = process.argv[4] ?? './output/ccrstest/';
